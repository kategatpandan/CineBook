...
<script>
// Global variables - properly set from PHP
let userPoints = <?php echo $userPointsJS; ?>;
let isLoggedIn = <?php echo $isLoggedInJS; ?>;
...
<!-- REST OF YOUR HTML REMAINS THE SAME UNTIL THE BOTTOM SCRIPT -->

<!-- ... (all your HTML content remains exactly the same) ... -->

<!-- At the very bottom, replace with this single script -->
<script>
// ===== INITIALIZATION =====
